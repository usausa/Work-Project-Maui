...
public sealed class ProgressConfig
{
    ...
    public Color IndicatorColor1 { get; set; } = Colors.DeepSkyBlue;
    public Color IndicatorColor2 { get; set; } = Colors.White;
    public float IndicatorWidth { get; set; } = 4;
    public float IndicatorSpeed { get; set; } = 6;
    public float IndicatorRadius { get; set; } = 16;
    public float IndicatorSweep { get; set; } = 30;
