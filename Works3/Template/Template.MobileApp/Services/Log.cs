...
internal static partial class Log
{
    ...
    [LoggerMessage(Level = LogLevel.Information, Message = "Re-login. id=[{id}], expires=[{expires}]")]
    public static partial void InfoReLogin(this ILogger logger, string id, DateTime? expires);

    [LoggerMessage(Level = LogLevel.Warning, Message = "Re-login failed. result=[{restResult}], statusCode=[{statusCode}]")]
    public static partial void WarnReLoginFailed(this ILogger logger, RestResult restResult, int statusCode);
