...
public static class Extensions
{
    ...
    // バインド中のビットマップの所有権はImageSource側にあるものとして扱い、差し替え時に旧ビットマップを解放する。VM破棄時はnullを渡して解放する
    public static void ReplaceBitmap(this SKBitmapImageSource source, SKBitmap? bitmap)
    {
