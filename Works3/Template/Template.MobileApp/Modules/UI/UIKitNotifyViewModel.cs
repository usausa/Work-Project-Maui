...
public sealed class UIKitNotifyItem
{
...
public sealed class UIKitNotifyViewModel : AppViewModelBase
{
    ...
    [
        new() { Icon = Fonts.MaterialIcons.Local_offer, Title = "50% off today", Description = "Spring sale ends tonight. Tap to explore.", Time = "5m" },
        new() { Icon = Fonts.MaterialIcons.Local_shipping, Title = "Your order is out for delivery", Description = "Estimated arrival: 14:30 - 16:00.", Time = "1h" },
        new() { Icon = Fonts.MaterialIcons.Mail, Title = "New message from Anna", Description = "Hey! Are we still meeting tomorrow?", Time = "3h" },
