...
public sealed class SoundEqualizer : GraphicsView, IDrawable
{
    // ------------------------------------------------------------
    // Property
    // ------------------------------------------------------------
    ...
    public static readonly BindableProperty RangeProperty =
        BindableProperty.Create(nameof(Range), typeof(int), typeof(SoundEqualizer), 10, propertyChanged: OnPropertyChanged);
    ...
    {
        ((SoundEqualizer)bindable).Invalidate();
    }
